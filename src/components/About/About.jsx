  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center w-screen md:p-10  mt-[1%] pt-[1%] pb-[1%] bg-[#2B2B29] p-48">
        ...
        Currently, I'm working as a consultant on an autonomous network project and at the same time I'm university professor of telematics in <a className=" duration-300 hover:bg-[#2a6ba0]" href="https://www.icesi.edu.co/">ICESI university.</a>
        <br/>
