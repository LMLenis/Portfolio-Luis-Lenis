...
const SlideBar = () => {
  ...
  return (
    <div className="flex right-0 items-center bg-[#467afdba] bg-opacity-100 md:flex-row sm:p-1 md:justify-center md:bottom-0 text-[15px] sm:text-[8px] md:static fixed top-40 p-4 flex-col">
